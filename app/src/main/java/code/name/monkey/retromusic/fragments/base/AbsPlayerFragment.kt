...
abstract class AbsPlayerFragment(@LayoutRes layout: Int) : AbsMusicServiceFragment(layout),
    ...
    protected fun handleMenuAction(id: Int): Boolean {
        ...
        when (id) {
            ...
            R.id.action_toggle_lyrics, R.id.action_toggle_lyrics_button -> {
            ...
            R.id.action_toggle_favorite, R.id.action_toggle_favorite_button -> {
                toggleFavorite(song)
                return true
            }
            ...
            R.id.now_playing, R.id.action_queue_button -> {
                requireActivity().findNavController(R.id.fragment_container).navigate(
            ...
            R.id.action_sleep_timer, R.id.action_sleep_timer_button -> {
            ...
            R.id.action_menu_button -> {
                val anchor = view?.findViewById<View>(R.id.action_menu_button) ?: return false
                val popupMenu = androidx.appcompat.widget.PopupMenu(requireContext(), anchor)
                popupMenu.inflate(R.menu.menu_player)
                popupMenu.setOnMenuItemClickListener { handleMenuAction(it.itemId) }
                popupMenu.show()
                return true
            }
        }
    ...
    private fun updateLyricsIcon() {
        ...
        // Update Individual Button if exists
        (view?.findViewById<View>(R.id.action_toggle_lyrics_button) as? androidx.appcompat.widget.AppCompatImageView)?.apply {
            setImageDrawable(drawable)
        }
    }

    open fun playerToolbar(): Toolbar? {
        return view?.findViewById(R.id.playerToolbar)
    }
    ...
    fun updateIsFavorite(animate: Boolean = false) {
        lifecycleScope.launch(IO) {
            ...
            withContext(Main) {
                ...
                // Update Individual Button if exists
                (view?.findViewById<View>(R.id.action_toggle_favorite_button) as? androidx.appcompat.widget.AppCompatImageView)?.apply {
                    setImageDrawable(drawable)
                }
            }
        }
    ...
    private fun setupBottomControls(view: View) {
        ...
        view.findViewById<View>(R.id.action_collapse)?.setOnClickListener {
            mainActivity.collapsePanel()
        }
        view.findViewById<View>(R.id.action_sleep_timer_button)?.setOnClickListener {
            handleMenuAction(R.id.action_sleep_timer_button)
        }
        view.findViewById<View>(R.id.action_toggle_lyrics_button)?.setOnClickListener {
            handleMenuAction(R.id.action_toggle_lyrics_button)
        }
        view.findViewById<View>(R.id.action_toggle_favorite_button)?.setOnClickListener {
            handleMenuAction(R.id.action_toggle_favorite_button)
        }
        view.findViewById<View>(R.id.action_queue_button)?.setOnClickListener {
            handleMenuAction(R.id.action_queue_button)
        }
        view.findViewById<View>(R.id.action_menu_button)?.setOnClickListener {
            handleMenuAction(R.id.action_menu_button)
        }
        updateLyricsIcon()
        updateIsFavorite()
    }
